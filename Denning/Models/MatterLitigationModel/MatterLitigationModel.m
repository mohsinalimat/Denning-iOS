...
+ (MatterLitigationModel*) getMatterLitigationFromResponse: (NSDictionary*) response
{
    ...
    model.courtInfo = [CourtModel getCourtFromResponse:[response objectForKeyNotNull:@"courtInfo"]];
    ...
    model.partyGroup = [PartyGroupModel getPartyGroupArrayFromResponse:[response objectForKeyNotNull:@"partyGroup"]];
