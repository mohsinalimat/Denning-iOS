...
#import "TaskCheckCell.h"

@interface TaskCheckListViewController ()
...
@implementation TaskCheckListViewController
...
- (void)registerNibs {
    [TaskCheckCell registerForReuseInTableView:self.tableView];
...
- (void) getList {
    ...
    [[QMNetworkManager sharedManager] getDashboardTaskCheckListInURL:self.url withPage:self.page withFilter:_filter withCompletion:^(NSArray * _Nonnull result, NSError * _Nonnull error) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TaskCheckModel *model = self.listOfProperties[indexPath.row];

    TaskCheckCell *cell = [tableView dequeueReusableCellWithIdentifier:[TaskCheckCell cellIdentifier] forIndexPath:indexPath];
    
    cell.clerkLabel.text = model.clerkName;
    cell.taskLabel.text = model.taskName;
    cell.fileNoLabel.text = model.fileNo;
    cell.startLabel.text = model.startDate;
    cell.endLabel.text = model.endDate;
    return cell;
