...
- (void) prepareUI {
    ...
    NSArray* temp = @[
                      @[@[@"File No (Auto Assigned)", @""], @[@"Ref 2", @""], @[@"Primary Client", @""], @[@"File Status", @""], @[@"Partner-in-Charge", @""], @[@"LA-in-Charge", @""], @[@"Clert-in-Charge", @""], @[@"Matter", @""], @[@"Location", @""], @[@"Pocket No", @""], @[@"Box", @""], @[@"Remarks", @""],
                          @[@"Save", @""]
                        ],
                      ...
                      @[@[@"Purchase Price (A)", @""], @[@"Earnest Deposit  (B)", @""], @[@"Deposit (C)", @""], @[@"Total Deposit (D) = B + C", @""], @[@"Balance (A - D)", @""], @[@"GST Amount", @""], @[@"Redemption Sum", @""], @[@"Term Loan Amt", @""], @[@"OD Loan Amt", @""], @[@"+ MRTA", @""], @[@"+ Legal Fee", @""], @[@"+ Other", @""], @[@"Total Loan", @""]],
    ...
    _headers = @[
                 @"Matter Information", @"Parties", @"Solicitors", @"Properties", @"Banks", @"Important RM", @"Important Date"
                 ];
