            ...
            completionHandler:(void (^)(NSArray *))handler
{
    ...
    NSString* autocompleteUrl = [NSString stringWithFormat:@"%@%@%@", serverAPI,COURT_HEARINGDETAIL_GET_URL, [string stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLFragmentAllowedCharacterSet]]];
